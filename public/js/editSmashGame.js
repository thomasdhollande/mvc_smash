document.querySelector("#edit_game_form").addEventListener("submit", (event) => {
    ...
    formData.append("game_id", document.querySelector("#game_id").value);

    fetch(`/api/game/edit/${document.querySelector("#game_id").value}`, {
        method: "POST",
        body: formData
    })
        .then(response => {
