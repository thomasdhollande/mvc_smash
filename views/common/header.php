...
<head>
    ...
    <link rel="stylesheet" href="<?= PUBLIC_PATH ?>style/main.css">
    <?php if (isset($css_file_name) && $css_file_name !== '') : ?>
        <link rel="stylesheet" href="<?= PUBLIC_PATH ?>style/<?= $css_file_name ?>.css">
    <?php endif; ?>
</head>
...
<body>
    <nav class="menu solano-bold">
        <div class="menu-logo">
            <a href="<?= PATH ?>"></a>
            <img src="<?= PUBLIC_PATH ?>images/logo/logo-smash-black.svg" alt="Logo Smash Black" class="logo-smash-black active">
            <img src="<?= PUBLIC_PATH ?>images/logo/logo-smash-white.svg" alt="Logo Smash White" class="logo-smash-white">
        </div>
